...
@property (nonatomic, strong)MultiButton *multiBtn;
...
- (void)createTopView {
    ...
    MultiButton *multiBtn = [[MultiButton alloc] initWithFrame:CGRectMake(0, 64, CGRectGetWidth(self.viewController.view.frame), 44) TitArr:self.titleArr];
    self.multiBtn = multiBtn;
    [self.viewController.view addSubview:multiBtn];
...
- (void)showTableViewWithIndex:(NSInteger)index {
    [UIView animateWithDuration:0.3 animations:^{
        ...
        frame.size.width = CGRectGetMaxX(self.viewController.view.frame);
